...
function RegisterView() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({
        text: "Error al registrar. Intente nuevamente.",
        type: "error",
      });
    ...
    `}
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="bg-purple-600 py-6 px-8">
          <h2 className="text-white text-2xl font-bold">Cear Cuenta</h2>
          <p className="text-purple-200 mt-1">Únase a nuestra comunidad hoy</p>
        </div>
